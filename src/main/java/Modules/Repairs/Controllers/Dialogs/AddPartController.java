 ...
 * Time: 12:40
 */
public class AddPartController implements Initializable, IControllerDialog {
    ...
    public void loaded(Object options) {
        if (options != null){
            ...
            StageServices.setTitleDialogByRoot((Stage)root.getScene().getWindow(), resourceBundle.getString("tab.repair.parts.edit_part.title"));
